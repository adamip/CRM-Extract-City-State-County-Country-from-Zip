/*	Adam Ip																	2012-10-09
	...
	new_ocountryregion is an option set										2013-01-23		
*/
...
function SiteAddressCountryCode_Change()
{
	try
	{
		WrapperExtractCountryFromCountryOptionSet( "new_countryregion", "new_ocountryregion" );
	}	
	catch( err )
	{
		window.alert( "function SiteAddressCountryCode_Change error code " + err );
